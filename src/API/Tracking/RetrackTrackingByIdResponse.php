...
class RetrackTrackingByIdResponse extends Base
{
    /**
    ...
    /**
     * @var CourierEstimatedDeliveryDateRetrackTrackingByIdResponse The field contains the estimated delivery date provided by the carrier.
     */
    ...
    public $order_tags;
    /**
     * @var AftershipEstimatedDeliveryDateRetrackTrackingByIdResponse The estimated delivery date of the shipment provided by AfterShip’s AI and shown to the recipients. It uses the format `YYYY-MM-DD` based on the shipment recipient’s timezone.
     */
    public $aftership_estimated_delivery_date;
    /**
     * @var CustomEstimatedDeliveryDateRetrackTrackingByIdResponse Estimated delivery time of the shipment based on your . It uses the format `YYYY-MM-DD` based on the shipment recipient’s timezone.
     */
