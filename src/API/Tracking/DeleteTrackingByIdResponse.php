...
class DeleteTrackingByIdResponse extends Base
{
    ...
    /**
     * @var CourierEstimatedDeliveryDateDeleteTrackingByIdResponse The field contains the estimated delivery date provided by the carrier.
     */
    ...
    public $order_tags;
    /**
     * @var AftershipEstimatedDeliveryDateDeleteTrackingByIdResponse The estimated delivery date of the shipment provided by AfterShip’s AI and shown to the recipients. It uses the format `YYYY-MM-DD` based on the shipment recipient’s timezone.
     */
    public $aftership_estimated_delivery_date;
    /**
     * @var CustomEstimatedDeliveryDateDeleteTrackingByIdResponse Estimated delivery time of the shipment based on your . It uses the format `YYYY-MM-DD` based on the shipment recipient’s timezone.
     */
    ...
    public $order_number;
    /**
     * @var FirstEstimatedDeliveryDeleteTrackingByIdResponse The shipment’s original estimated delivery date. It could be provided by the carrier, AfterShip AI, or based on your custom settings. The format of carrier EDDs may differ depending on how the carrier provides it:- YYYY-MM-DD- YYYY-MM-DDTHH:mm:ss- YYYY-MM-DDTHH:mm:ssZ AfterShip AI and custom EDDs always use the format `YYYY-MM-DD`. All EDDs use the shipment recipient’s timezone.
     */
    public $first_estimated_delivery;
    /**
     * @var LatestEstimatedDeliveryDeleteTrackingByIdResponse The most recently calculated estimated delivery date. It could be provided by the carrier, AfterShip AI, or based on your custom settings. The format of carrier EDDs may differ depending on how the carrier provides it:- YYYY-MM-DD- YYYY-MM-DDTHH:mm:ss- YYYY-MM-DDTHH:mm:ssZ AfterShip AI and custom EDDs always use the format `YYYY-MM-DD`. All EDDs use the shipment recipient’s timezone.
     */
    ...
    /**
     * @var FirstMileDeleteTrackingByIdResponse The field contains information about the first leg of the shipping starting from the carrier picking up the shipment from the shipper to the point where they hand it over to the last-mile carrier. Once AfterShip detects the shipment is multi-leg, we will populate the first-mile information under this object.
     */
    public $first_mile;
    /**
     * @var LastMileDeleteTrackingByIdResponse This field contains information about the last leg of the shipment, starting from the carrier who hands it over to the last-mile carrier, all the way to delivery. Once AfterShip detects that the shipment involves multiple legs and identifies the last-mile carrier, we will populate the last-mile carrier information in this object. Alternatively, the user can provide this information in this field to specify the last-mile carrier, which is helpful if AfterShip is unable to detect it automatically.
     */
    public $last_mile;
    /**
     * @var CustomersDeleteTrackingByIdResponse[] The field contains the customer information associated with the tracking. A maximum of three customer objects are allowed.
     */
    public $customers;
}
