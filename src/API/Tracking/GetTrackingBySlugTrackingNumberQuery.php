...
class GetTrackingBySlugTrackingNumberQuery extends \Tracking\API\Base\QueryBase
{
    /**
     * @var string|null List of fields to include in the response. Use comma for multiple values. Fields to include: `tracking_postal_code`, `tracking_ship_date`, `tracking_account_number`, `tracking_key`, `tracking_origin_country`, `tracking_destination_country`, `tracking_state`, `title`, `order_id`, `tag`, `checkpoints`
     */
    public $fields;
    /**
    ...
    public function setFields(string $fields): GetTrackingBySlugTrackingNumberQuery
    {
        $this->fields = $fields;
        return $this;
    }
    public function setLang(string $lang): GetTrackingBySlugTrackingNumberQuery
    {
        $this->lang = $lang;
        return $this;
    }
    public function setTrackingAccountNumber(string $tracking_account_number): GetTrackingBySlugTrackingNumberQuery
    {
        $this->tracking_account_number = $tracking_account_number;
        return $this;
    }
    public function setTrackingOriginCountry(string $tracking_origin_country): GetTrackingBySlugTrackingNumberQuery
    {
        $this->tracking_origin_country = $tracking_origin_country;
        return $this;
    }
    public function setTrackingDestinationCountry(string $tracking_destination_country): GetTrackingBySlugTrackingNumberQuery
    {
        $this->tracking_destination_country = $tracking_destination_country;
        return $this;
    }
    public function setTrackingKey(string $tracking_key): GetTrackingBySlugTrackingNumberQuery
    {
        $this->tracking_key = $tracking_key;
        return $this;
    }
    public function setTrackingPostalCode(string $tracking_postal_code): GetTrackingBySlugTrackingNumberQuery
    {
        $this->tracking_postal_code = $tracking_postal_code;
        return $this;
    }
    public function setTrackingShipDate(string $tracking_ship_date): GetTrackingBySlugTrackingNumberQuery
    {
        $this->tracking_ship_date = $tracking_ship_date;
        return $this;
    }
    public function setTrackingState(string $tracking_state): GetTrackingBySlugTrackingNumberQuery
    {
