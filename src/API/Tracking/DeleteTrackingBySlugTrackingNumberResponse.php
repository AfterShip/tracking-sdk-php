...
class DeleteTrackingBySlugTrackingNumberResponse extends Base
{
    /**
    ...
    public $order_tags;
    /**
     * @var AftershipEstimatedDeliveryDateDeleteTrackingBySlugTrackingNumberResponse The estimated delivery date of the shipment provided by AfterShip’s AI and shown to the recipients. It uses the format `YYYY-MM-DD` based on the shipment recipient’s timezone.
     */
    public $aftership_estimated_delivery_date;
    /**
     * @var CustomEstimatedDeliveryDateDeleteTrackingBySlugTrackingNumberResponse Estimated delivery time of the shipment based on your . It uses the format `YYYY-MM-DD` based on the shipment recipient’s timezone.
     */
    ...
    /**
     * @var NextCouriersDeleteTrackingBySlugTrackingNumberResponse[] The next couriers get the second carrier information from user or AfterShip.
     */
