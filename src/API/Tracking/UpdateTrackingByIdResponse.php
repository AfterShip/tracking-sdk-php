...
class UpdateTrackingByIdResponse extends Base
{
    /**
    ...
    /**
     * @var CourierEstimatedDeliveryDateUpdateTrackingByIdResponse The field contains the estimated delivery date provided by the carrier.
     */
    ...
    public $order_tags;
    /**
     * @var AftershipEstimatedDeliveryDateUpdateTrackingByIdResponse The estimated delivery date of the shipment provided by AfterShip’s AI and shown to the recipients. It uses the format `YYYY-MM-DD` based on the shipment recipient’s timezone.
     */
    public $aftership_estimated_delivery_date;
    /**
     * @var CustomEstimatedDeliveryDateUpdateTrackingByIdResponse Estimated delivery time of the shipment based on your . It uses the format `YYYY-MM-DD` based on the shipment recipient’s timezone.
     */
    ...
    /**
     * @var FirstMileUpdateTrackingByIdResponse The field contains information about the first leg of the shipping starting from the carrier picking up the shipment from the shipper to the point where they hand it over to the last-mile carrier. Once AfterShip detects the shipment is multi-leg, we will populate the first-mile information under this object.
     */
    public $first_mile;
    /**
     * @var LastMileUpdateTrackingByIdResponse This field contains information about the last leg of the shipment, starting from the carrier who hands it over to the last-mile carrier, all the way to delivery. Once AfterShip detects that the shipment involves multiple legs and identifies the last-mile carrier, we will populate the last-mile carrier information in this object. Alternatively, the user can provide this information in this field to specify the last-mile carrier, which is helpful if AfterShip is unable to detect it automatically.
     */
    public $last_mile;
    /**
     * @var CustomersUpdateTrackingByIdResponse[] The field contains the customer information associated with the tracking. A maximum of three customer objects are allowed.
     */
    public $customers;
}
