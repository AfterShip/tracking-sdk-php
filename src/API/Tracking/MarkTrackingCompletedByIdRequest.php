...
class MarkTrackingCompletedByIdRequest extends Base
{
    ...
    public $reason;
    /**
     * @var string The actual occurrence time of the marked tracking status.The field supports the following formats: - YYYY-MM-DD- YYYY-MM-DDTHH:mm:ss- YYYY-MM-DDTHH:mm:ssZ
     */
