...
class Courier extends APIBase
{
    ...
    */
    public function getCouriers(
        ...
        $httpResp = $this->httpClient->request('GET', sprintf("/tracking/2026-07/couriers"), $options);
    ...
    */
    public function detectCourier(
        ...
        $httpResp = $this->httpClient->request('POST', sprintf("/tracking/2026-07/couriers/detect"), $options);
