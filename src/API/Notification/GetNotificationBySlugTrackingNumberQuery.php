...
class GetNotificationBySlugTrackingNumberQuery extends \Tracking\API\Base\QueryBase
{
    /**
    ...
    public function setTrackingAccountNumber(string $tracking_account_number): GetNotificationBySlugTrackingNumberQuery
    {
        $this->tracking_account_number = $tracking_account_number;
        return $this;
    }
    public function setTrackingOriginCountry(string $tracking_origin_country): GetNotificationBySlugTrackingNumberQuery
    {
        $this->tracking_origin_country = $tracking_origin_country;
        return $this;
    }
    public function setTrackingDestinationCountry(string $tracking_destination_country): GetNotificationBySlugTrackingNumberQuery
    {
        $this->tracking_destination_country = $tracking_destination_country;
        return $this;
    }
    public function setTrackingKey(string $tracking_key): GetNotificationBySlugTrackingNumberQuery
    {
        $this->tracking_key = $tracking_key;
        return $this;
    }
    public function setTrackingPostalCode(string $tracking_postal_code): GetNotificationBySlugTrackingNumberQuery
    {
        $this->tracking_postal_code = $tracking_postal_code;
        return $this;
    }
    public function setTrackingShipDate(string $tracking_ship_date): GetNotificationBySlugTrackingNumberQuery
    {
        $this->tracking_ship_date = $tracking_ship_date;
        return $this;
    }
    public function setTrackingState(string $tracking_state): GetNotificationBySlugTrackingNumberQuery
    {
