...
class TrackingFirstMile extends Base
{
    /**
     * @var string|null The tracking number of the first-mile carrier.
     */
    public $tracking_number;

    /**
     * @var string|null The unique code of the carrier responsible for the first-mile of the shipment. Find all the courier slugs .
     */
    public $slug;
